...
function EditEmployee() {
    ...
    const [employee, setemployee] = useState<Employee>(employees[employees.findIndex(e => e.id === employeeId)]);
    ...
    return (
        <View style={styles.container}>
            <View style={[styles.headerContainer, { height: height * 0.12 }]}>
                <Pressable style={{ flexDirection: 'row' }} onPress={() => history.push("/authed/report/employeesreport")}>
                    ...
                    <View style={styles.addHoursContainer}>
                        ...
                        <View style={styles.addHoursRow}>
                            ...
                            <Pressable style={styles.addBtn}
                                onPress={() => {
                                    if (!dateSelected || !startTime || !endTime) return alertP.error('Please fill out all fields')
