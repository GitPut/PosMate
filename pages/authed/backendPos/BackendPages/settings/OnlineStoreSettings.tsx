          ...
          <View style={styles.innerGroup}>
            <View style={styles.inputsGroup}>
              <View style={styles.urlEndingInputGroup}>
                ...
                {onlineStoreDetails.onlineStoreSetUp ? (
                  <Pressable
                    style={[styles.uRLBox, { justifyContent: "center" }]}
                  >
                    <Text>{onlineStoreDetails.urlEnding}</Text>
                  </Pressable>
                ) : (
                  <TextInput
                    style={styles.uRLBox}
              ...
              <View style={styles.stripePublicKeyInputGroup}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) => {
                    setstripePublicKey(text);
                  }}
                />
              </View>
              <View style={styles.stripePrivateKeyInputGroup}>
                <Text style={styles.stripePrivateKeyTxt}>
                  Stripe Private Key
                </Text>
                <TextInput
            ...
            <View style={styles.bottomBtnGroup}>
              ...
              {onlineStoreDetails.onlineStoreSetUp ? (
                ...
                <Pressable style={styles.confirmBtn} onPress={startOnlineStore}>
